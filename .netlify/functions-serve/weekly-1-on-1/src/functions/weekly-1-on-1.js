    ...
    var wrapHandler = function(handler2) {
      return function(event, context, callback) {
        ...
        var wrappedCallback = function(error, response) {
          return callback(error, augmentResponse(response));
        };
...
var require_secrets_helper = __commonJS({
  "node_modules/@netlify/functions/dist/lib/secrets_helper.js"(exports2) {
    "use strict";
    var __assign = exports2 && exports2.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    exports2.getSecrets = getSecrets;
  }
});

// node_modules/@netlify/functions/dist/lib/secrets.js
var require_secrets = __commonJS({
  "node_modules/@netlify/functions/dist/lib/secrets.js"(exports2) {
    "use strict";
    var __assign = exports2 && exports2.__assign || function() {
      __assign = Object.assign || function(t) {
        for (var s, i = 1, n = arguments.length; i < n; i++) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.withSecrets = exports2.getSecrets = void 0;
    var secrets_helper_1 = require_secrets_helper();
    var secrets_helper_2 = require_secrets_helper();
    Object.defineProperty(exports2, "getSecrets", { enumerable: true, get: function() {
    ...
    exports2.withSecrets = withSecrets;
  }
});
...
var require_function = __commonJS({
  "node_modules/@netlify/functions/dist/function/index.js"(exports2) {
    ...
    Object.defineProperty(exports2, "withSecrets", { enumerable: true, get: function() {
...
var require_main = __commonJS({
  "node_modules/@netlify/functions/dist/main.js"(exports2) {
    ...
    Object.defineProperty(exports2, "__esModule", { value: true });
    exports2.schedule = exports2.builder = void 0;
...
var oneOnOneId = "43268142d5e04ac090aa86f14c1cba1d";
...
var handler = async () => {
  ...
  const entriesArray = await Promise.all(pagesResponse.results.map(async (result) => {
    ...
    const bulletPoints = results.map((result2) => {
      ...
      const points = (_a = bulleted_list_item == null ? void 0 : bulleted_list_item.text[0]) == null ? void 0 : _a.plain_text;
      return points;
    });
...
module.exports.handler = (0, import_functions.schedule)("0 9 * * SUN", handler);
//# sourceMappingURL=weekly-1-on-1.js.map
