    ...
    var UnknownHTTPResponseError = class extends HTTPResponseError {
      constructor(args) {
        ...
        super(__spreadProps(__spreadValues({}, args), {
          ...
          message: (_a4 = args.message) !== null && _a4 !== void 0 ? _a4 : `Request to Notion API failed with status: ${args.status}`
        }));
...
// node_modules/@notionhq/client/node_modules/node-fetch/lib/index.js
var require_lib2 = __commonJS({
  "node_modules/@notionhq/client/node_modules/node-fetch/lib/index.js"(exports2, module2) {
    "use strict";
    Object.defineProperty(exports2, "__esModule", { value: true });
...
var require_Client = __commonJS({
  "node_modules/@notionhq/client/build/src/Client.js"(exports2) {
    "use strict";
    var __classPrivateFieldSet = exports2 && exports2.__classPrivateFieldSet || function(receiver, state, value, kind, f3) {
      if (kind === "m")
    ...
    var __classPrivateFieldGet = exports2 && exports2.__classPrivateFieldGet || function(receiver, state, kind, f3) {
      if (kind === "a" && !f3)
    ...
    var Client2 = class {
      constructor(options) {
        ...
        __classPrivateFieldSet(this, _Client_logLevel, (_a4 = options === null || options === void 0 ? void 0 : options.logLevel) !== null && _a4 !== void 0 ? _a4 : logging_1.LogLevel.WARN, "f");
        ...
        __classPrivateFieldSet(this, _Client_timeoutMs, (_d2 = options === null || options === void 0 ? void 0 : options.timeoutMs) !== null && _d2 !== void 0 ? _d2 : 6e4, "f");
...
// functions/ryan-warner-llc-invoice.ts
...
var waveAppsUserId = process.env.WAVE_APPS_USER_ID;
var waveAppsEndpoint = process.env.WAVE_APPS_API_ENDPOINT;
var waveAppsFullAccesToken = process.env.WAVE_APPS_FULL_ACCESS_TOKEN;
...
var handler = async () => {
  ...
  const entriesArray = await Promise.all(pagesResponse.results.map(async (result) => {
    const { id } = result;
    const { results } = await notion.blocks.children.list({
      block_id: id
    });
    const bulletPoints = results.map((result2) => {
      var _a4;
      const { bulleted_list_item } = result2;
      const points = (_a4 = bulleted_list_item == null ? void 0 : bulleted_list_item.text[0]) == null ? void 0 : _a4.plain_text;
      return points;
    });
...
//# sourceMappingURL=ryan-warner-llc-invoice.js.map
